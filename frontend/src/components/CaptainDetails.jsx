...
const CaptainDetails = () => {
    ...
    // Check if captain and captain.fullname are available
    const fullname = captain?.fullname ? `${captain.fullname.firstname} ${captain.fullname.lastname}` : "Captain Name Not Available";
